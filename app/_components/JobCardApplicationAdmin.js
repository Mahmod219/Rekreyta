...
export default function JobCardApplicationAdmin({ job, applicantsCount = 0 }) {
  const { id, title, company, image_url } = job;

  return (
    <div className="relative group rounded-3xl border border-gray-100 bg-white p-5 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:border-[#2ecc91]/30">
