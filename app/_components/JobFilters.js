...
export default function JobFilters() {
  return (
    <div className="grid grid-cols-1 items-center  sm:grid-cols-2 lg:grid-cols-2 gap-4 bg-white/90 backdrop-blur-md p-4 sm:p-6 rounded-3xl shadow-lg border border-gray-100 w-full mb-5">
