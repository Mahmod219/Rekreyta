...
import InputField from "./InputField"; // تأكد من استيراد النسخة المنسقة
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
        {/* الصف الأول: العنوان والشركة */}
        <InputField
          label="Job Title"
          name="title"
          icon={IdentificationIcon} // أيقونة المسمى الوظيفي
        ...
        <InputField
          label="Company Name"
          name="company"
          icon={BuildingOfficeIcon} // أيقونة الشركة
          placeholder="e.g. Spotify"
          error={state?.fieldErrors?.company}
        />

        {/* الصف الثاني: الفئة والموقع */}
        <CustomSelect
          label="Job Category"
          name="category"
          icon={TagIcon}
        ...
        <InputField
          label="Duration"
          name="duration"
          icon={ClockIcon} // أيقونة مدة العمل
          placeholder="e.g. 6 Months or Permanent"
          error={state?.fieldErrors?.duration}
        />

        {/* الصف الرابع: الراتب والموعد النهائي */}
        <InputField
          label="Salary"
          name="salary"
          icon={CurrencyDollarIcon} // أيقونة الراتب
        ...
        <InputField
          ...
          icon={CalendarIcon} // أيقونة التقويم
          type="date"
          error={state?.fieldErrors?.application_deadline}
        />

        {/* حقل العنوان الكامل - يأخذ سطر كامل */}
        ...
        {/* رفع الصورة - سطر كامل بتصميم أنيق */}
        <div className="md:col-span-2">
